...
public class S70 extends Car {
	...
	//no args
	public S70() {
		super.setPrice(36000); //hard code the price
		this.setModel("S70");
	...
	//full params
	public S70(boolean metallicPaint, boolean tradeIn, double tradeInValue, boolean financing, boolean payCash, int numPackage) { //add from this class
		super(metallicPaint, tradeIn, tradeInValue, financing, payCash);
		this.setPrice(36000); //hard code the price
		this.setModel("S70");
